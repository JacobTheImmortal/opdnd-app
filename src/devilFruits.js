export const devilFruits = [
  ...
  {
    name: "Potion potion",
    ability: "You are pretty cool, or warm, or fast, or sleepy, or high. Whatever you just drank probably did it. You can take up to 8 oz of any liquid and add effects to it. Once consumed, the effects apply. Effects include -  Positive - (Strength, Reflexive, Energize, Revitalize, Aware, Tough). Negative - (Weak, Hazed, Exhaust, Drunk, Explode, PaperThin). Your potions don't work when thrown. They only take effect once a target drinks a full 8 oz of the material. Potions last 1 hour or until used up. You can add up to 2 Positive effects to any potion, but you have to also add 1 negative effect for every 2 positive ones. Negative effects will take place after positive ones wear off. Strength - Advantage on Strength rolls. In Battle, Double damage for 2 turns. Reflexive - Gain advantage on Rolls for dodging for 4 turns. Energize - Gain back 25% of your Bar. Instant Use. Revitalize - Gain Back 25% of your health. Instant Use. Aware - Gain advantage on WIS/INT rolls. Tough - Unarmed Melee attacks do no damage. Melee attacks do half damage. 2 Turns. Weak - Disadvantage on strength rolls. In battle Half damage for 2 turns. Hazed - Gain disadvantage on Rolls for dodging for 4 turns. Exhaust - Lose Half your Bar. Explode - Blow up in a 10ft radius. Lose Half your Max Health. Drunk - Gain disadvantage on WIS/INT rolls. PaperThin - All Attacks do Double damage to you.",
  },
  {
    name: "Rat rat",
